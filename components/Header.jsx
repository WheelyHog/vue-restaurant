...
const Header = () => {
    ...
    return (
        <header className={`${active ? 'bg-black-heavy py-4' : 'bg-black-heavy py-8'} fixed top-0 w-full z-50 left-0 right-0 transition-all duration-200`}>
            <div className="container mx-auto">
                {/*logo, nav, btn*/}
                <div className="flex items-center justify-between">
                    {/*logo*/}
                    <Link href="/">
                        <Image src="/logo.svg" alt="" width={75} height={30}/>
                    </Link>
                    {/*nav*/}
